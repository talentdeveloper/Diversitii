...
/**
 * TextView that shrinks text to a minimum size to fit in a view.
 */
public class ResizingTextView extends TextView { // for Nox compatibility issue
    ...
    public void resizeText(int width, int height) {
        ...
        while (textHeight > height && targetTextSize > Constants.MIN_TEXT_SIZE) {
            targetTextSize = Math.max(targetTextSize - 2, Constants.MIN_TEXT_SIZE);
